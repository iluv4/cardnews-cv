...
def main():
    ...
    testing_dl = DataLoader(testing_set, num_workers=0, batch_size=test_batch_size, shuffle=False)
    ...
    fix_noise = random_init(test_batch_size, max_elem).to(device)
    ...
    for k, v in ckpt.items():
        name = k[7:] if k.startswith("module.") else k # remove DataParallel prefix
